    ...
    <section id="about" className="py-32 relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold leading-tight animaate-fade-in animation-delay-100 text-secondary-foreground ">
            Building the future,
          ...
          <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200">
            <p>
              I'm a passionate frontend developer experience with crafting
              digital products that make a difference. My journey started with a
              curiosity for how things work on the web, and it has evolved into
              a deep expertise in modern frontend technologies.
            </p>
            <p>
              I specialize in React, JavaScript,HTML,and CSS building everything
